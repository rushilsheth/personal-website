...
* Hosted and fine-tuned open source LLMs via LoRA and DSPy for cost reduction and flexibility on task
routing. Utilized a dataset, both human and synthetic, that was aligned with customer intent
